...
/*
numberOfTeeth = the number of teeth the thing will make. Integer value.
MINIMUM 3 for good results (Input 1 for some REALLY strange results)

numberOfSpokes = the number of spokes created- integer value
circlizer- higher value makes the surface of most surfaces more circular.
MINIMUM 1. Values over 1000 may effect performance
spokeFraction - the spokes take 1/spokefraction of the space from them to the
 next spoke. Smaller number makes wider spokes, Minimum 2;
spokeZFatness - a double between 1 and 10,
 determines the z thickness of the spoke
smallCoinFactor - a number between 0 and 1 representing the size of the smal
l innner coin as a fraction of the size of the gear.
red/gren/blue - integer rgb values. 0-255
*/
function createOxfordGear(numberOfTeeth, numberOfSpokes, circlizer,
	 spokeFraction, spokeZFatness, smallCoinFactor, red, green, blue) {
    var vertices = [];
    var colors = [];
    var normals = [];
