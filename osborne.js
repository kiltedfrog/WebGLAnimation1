...
function osbornemGear(numTeeth, numSpokes) {
  ...
  let centerColor = [0.5, 0.6, 0.7];
  let innerCoinOuterColor = [0.5, 0.6, 0.7];
  let outerCointInnerColor = [0.5, 0.6, 0.7];
  let outerCoinOuterColor = [0.5, 0.7, 0.7];
  let teethEdgeColor = [0.5, 0.8, 0.6];
